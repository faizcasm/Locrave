...
export const Download = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Download - Locrave"
        description="Download Locrave app for iOS and Android. Join your neighborhood community today and connect with neighbors."
        url="https://locrave.com/download"
      />
